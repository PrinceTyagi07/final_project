             ...
             ${change === true ? "" : ""}  py-1 shadow-md shadow-gray-300`}>
                    ...
                    <div className='logo font-bold text-2xl md:text-xl tracking-wider text-[#23B6AA]  flex gap-2 '>
                        ...
                        <NavLink to={'/'} className='flex flex-col space-y-2 items-center'>
                            <img src={im} alt="" className="md:w-[40px]  md:h-[40px] w-[35px]" />
                    ...
                    <div className={` md:flex-row capitalize gap-8  py-8  absolute md:static md:bg-white transition-all  duration-600 ease-in top-6 flex flex-col   ${change === true ? "flex flex-col top-[41px] bg-white px-10 left-[-20px]" : "left-[-200px]"} list-none`}>
